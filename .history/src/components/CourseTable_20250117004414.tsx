...
import { updateCourse, addCourse, calculateStats } from '../store/courseSlice';
...
const CourseTable: React.FC = () => {
    ...
    const handleGradeChange = (courseId: string, letterGrade: LetterGrade) => {
        console.log('Updating grade for course:', courseId, 'to:', letterGrade);
    ...
    const handleStatusChange = (courseId: string, status: CourseStatus) => {
        console.log('Updating status for course:', courseId, 'to:', status);
        const courseToUpdate = courses.find(course => course.id === courseId);
        if (!courseToUpdate) {
            console.error('Course not found:', courseId);
            return;
        ...
        },
        {
            ...
            render: (_: LetterGrade | undefined, record: Course) => (
                <Select
                    ...
                    onChange={(value: LetterGrade) => {
                        console.log('Selected grade for course:', record.code, record.id, value);
        ...
        },
        {
            ...
            render: (_: CourseStatus | undefined, record: Course) => (
                <Select
                    ...
                    onChange={(value: CourseStatus) => {
                        console.log('Selected status for course:', record.code, record.id, value);
